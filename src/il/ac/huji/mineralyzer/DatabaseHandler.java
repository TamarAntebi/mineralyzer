...
public class DatabaseHandler extends SQLiteOpenHelper 
{
	...
	public void onCreate(SQLiteDatabase db) {
        ...
        //insert values
        addItem("סמקטיט-איליט", "סוגי חרסית. מינרלים יציבים, תוצרים של בלייה או של פעולת תמיסות מימיות חמות על פלדספטים  ומינרלים אחרים (אך לא קוורץ). נפוץ מאד בסלעי משקע קלאסטיים (הנוצרים מבליה) לוּטיטי (שגודל חלקיקו קטן מ-1/16 ממ). המינרל מאופיין בגביש זעיר הבנוי מסיליקה  ואלומינה ובנטייה לספוח מים ולתפוח.", "claystone.jpg");
        addItem("קאוליניט", "סוג של חרסית. נוצר עקב בליה כימית של מינרלים אלומו־סיליקטיים הכוללים אלומיניום דוגמת פצלת השדה. את הקאוליניט כורים (כקאולין) בברזיל, צרפת, בריטניה, גרמניה, הודו, אוסטרליה, יפן, סין ובמדינות דרום מזרח ארצות הברית. בישראל מצויות שכבות ועדשות של קאוליניט באבני חול מתור היורה והקרטיקון התחתון במכתשים בנגב והן מנוצלות לצורכי התעשייה הקרמית. אינו תופח במגע עם מים.", "kaolinite.jpg");
        addItem("גבס", "מינרל רך מאוד המורכב מסידן וגופרית. ברוב המקרים הגבס הוא משקע הנוצר כאשר מים מתאדים בלגונות ימיות או באגמים סגורים. באזורים מדבריים נוצר הגבס כקרום מעלייה נימית של מי תהום מלוחים. ישנן כמויות מעטות של גבס הנוצרות ממוצא געשי כאשר הגזים העשירים במימן גופרתי מתרכבים עם הסלעים הסידניים שבסביבת ההתפרצות. כמויות מסחריות של גבס מצויות באנגליה, קנדה, ובניו יורק, מישיגן, איווה, קנזס, ניו מקסיקו, קולורדו ויוטה בארצות הברית. כאשר מחממים את הגבס מעל ל-150 מעלות צלזיוס מתאיידים 75% מהמים האגורים במבנה הכימי שלו.", "geves.jpg");
        ...
        addItem("קלציט", "מינרל קרבונטי והפולימורף היציב ביותר של סידן פחמתי. הוא אחד המינרלים הנפוצים ביותר על פני כדור הארץ ומהווה כ-4% ממסת קרום כדור הארץ. הקלציט מהווה את המרכיב עיקרי בסלעי משקע, בעיקר גיר, קרטון וחוואר (יחד עם חרסיות), והוא גם המינרל העיקרי בסלע המותמר שיש, כמו גם המינרל הבונה נטיפים וזקיפים במערות. הקלציט מהווה את המרכיב העיקרי בשלד החיצוני של הרבה יצורים ימיים כמו פלנקטון וצדפות.", "Calcite.jpg");
        ...
        addItem("לימוניט", "מכיל לעתים כמויות משתנות של תחמוצות לעומת הידרוקסידים. יחד עם המטיט ומגנטיט, לימוניט הוא אחד מתחמוצות הברזל. נמצא בעיקר בתוך או ליד ברזל מחומצן או מרבצי מתכות אחרות. מקור השם לימוניט הוא במילה היוונית לאדמת מרעה, מכיוון שהוא מופיע לעתים באחו ומרחבים אחרים. לימוניט הוא מינרל פסאודומורפי, כלומר, הוא יכול להתגבש בתבנית של מינרל שקדם לו (פיריט לדוגמה) ולהשאר בצורה הגבישית החיצונית שלו.", "Limonite.jpg");
        ...
        addItem("אוליבין", "מינרל הוא בעצם שורת מינרלים איזומורפיים, כלומר תרכובות דומות בהרכבן , שבהן כמויות משתנות של מגנזיום וברזל. הרכבן נע בין שני הקצוות: מפורסטריט המכיל מגנזיום בלבד, ועד פאיאליט המכיל ברזל בלבד. האגודה הבינלאומית למינרלוגיה אינה מכירה יותר בשם אוליבין כשם חוקי למינרל, אלא רק כתערובת בין פורסטריט לפאיאליט. על שם האוליבין קרויה קבוצת האוליבין, משפחה של מינרלים במבנה דומה.", "olivin.jpg");
        addItem("פלדספר", "אחת מקבוצות המינרלים החשובות ביותר שמהם בנויים סלעי היסוד. הקבוצה קרויה בעברית גם קבוצת הפלדספּרים (שמה באנגלית) או גם פלדספטים. עד כ-60% מקרום כדור הארץ בנוי מפצלות השדה. פצלות השדה מתגבשות ממאגמה הן בסלעי תהום (סלעים פלוטוניים) והן בסלעי פרץ (סלעים וולקניים). פצלות השדה מצויות גם בסוגים רבים של סלעים מותמרים וסלעי משקע.", "feldshepr.jpg");
        addItem("מגנטיט", "המינרל המגנטי ביותר על כדור הארץ ומצפנים קדומים היו מורכבים ממנו. מגנטיט מתמוסס באיטיות בחומצת מלח וגרגריו נמצאים כמעט בכל סלעי היסוד וברוב סלעי המשקע, בנוסף לכך מגנטיט הוא מקור חשוב להפקת ברזל. גבישי מגנטיט נמצאו במספר בקטריות ובמוחן של דבורים, טרמיטים ומספר ציפורים (לדוגמה יונה). גם בבני אדם נמצא גביש מגנטיט זעיר באף. השערות מציעות שאורגניזמים מסוימים יכולים לחוש בשדה המגנטי של כדור הארץ בעזרת גבישי המגנטיט שמצויים בגופם וכך לנווט.", "Magnetite.jpg");
        addItem("קוורץ", "קוורץ הוא המינרל השני הנפוץ ביותר בקרום כדור הארץ. שייך לקבוצת המינרלים הסיליקטיים שהם הקבוצה החשובה ביותר בין המינרלים יוצרי הסלעים. קוורץ מצוי הן בסלעי יסוד כדוגמת הגרניט, סלעי משקע כדוגמת אבן החול וסלעים מותמרים כדוגמת שיסט. הקוורץ הוא המינרל האחרון בשורת בואן להתגבש (בטמפרטורה של כ-600 מעלות) כשמאגמה מתמצקת ליצירת סלעי יסוד. מקובל לסווג סלעים אלו בהתאם לכמות הקוורץ שבהם. מעל 10% קוורץ הוא סלע חומצי. 0%-10% הוא סלע בינוני, הסלעים הבסיסיים והאולטרא בסיסיים אינם מכילים קוורץ.", "Quartz.jpg");
        addItem("דולומיט", "דולומיט הוא מינרל נפוץ הבנוי מפחמה (קרבונט) של סידן ומגנזיום והוא גם שמו של סוג סלע המשקע (דולומיט) הבנוי בעיקר ממינרל זה. קיימת אי-ודאות משמעותית לגבי הסיבה להיווצרות הדולומיט. מרבצים עבים של דולומיט, לעתים של מאות מטרים מצויים בחתכים גאולוגיים, אך המינרל נדיר למדי בשכבות מודרניות. לעובדה זו מתייחסים כאל - בעיית הדולומיט", "Dolomite.jpg");
	}
